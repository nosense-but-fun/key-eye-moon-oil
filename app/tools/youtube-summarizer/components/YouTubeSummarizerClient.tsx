...
interface YouTubeSummarizerClientProps {
  dictionary: {
...
export default function YouTubeSummarizerClient({
  ...
  const loadingMessages = dictionary.youtube_summarizer_tool.loading_messages;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8 text-center text-gray-900 dark:text-white">
        {dictionary.youtube_summarizer_tool.title}
      </h1>
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 text-center">
        {dictionary.youtube_summarizer_tool.description}
      </p>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-8">
        <div className="flex gap-4">
          <input
            ...
            placeholder={dictionary.youtube_summarizer_tool.input.placeholder}
          ...
          >
            {loading
              ? dictionary.youtube_summarizer_tool.input.button.loading
              : dictionary.youtube_summarizer_tool.input.button.default}
          </button>
        </div>
      </form>
      ...
      {summary && analysis && channelData && (
        <SummaryDisplay
          ...
          dictionary={dictionary.youtube_summarizer_tool}
        />
      )}
    </div>
  );
